...
func main() {
	...
	request.AppId = 10002
	request.Guid = "046A43579DcdcD54EaAC22a53faF46dfcd87"
	request.LoginType = 1
	request.ApkVer = "1.0.0.1000"
	request.HallVer = 1000
	request.PhoneParam.Phone = "18633333337"
	request.PhoneParam.Captcha = "6332"
	request.WechatParam.UnionId = ""
