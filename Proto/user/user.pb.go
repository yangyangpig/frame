...
type InsertUserRequest struct {
	...
	Cid              int64  `protobuf:"varint,12,req,name=cid" json:"cid"`
...
func (m *InsertUserRequest) GetCid() int64 {
	if m != nil {
		return m.Cid
	}
	return 0
...
func (m *InsertUserResponse) GetStatus() int32 {
	if m != nil {
		return m.Status
	}
	return 0
...
type UpdateUserRequest struct {
	...
	Sex              int32  `protobuf:"varint,3,opt,name=sex" json:"sex"`
	Icon             string `protobuf:"bytes,4,opt,name=icon" json:"icon"`
	IconBig          string `protobuf:"bytes,5,opt,name=icon_big,json=iconBig" json:"icon_big"`
...
func NewPopulatedInsertUserRequest(r randyUser, easy bool) *InsertUserRequest {
	...
	if !easy && r.Intn(10) != 0 {
		this.XXX_unrecognized = randUnrecognizedUser(r, 13)
	}
	return this
}
...
func NewPopulatedUpdateUserRequest(r randyUser, easy bool) *UpdateUserRequest {
	...
	if !easy && r.Intn(10) != 0 {
		this.XXX_unrecognized = randUnrecognizedUser(r, 7)
	}
	return this
}
...
func init() { proto.RegisterFile("user/user.proto", fileDescriptorUser) }

var fileDescriptorUser = []byte{
	// 785 bytes of a gzipped FileDescriptorProto
	,
}
